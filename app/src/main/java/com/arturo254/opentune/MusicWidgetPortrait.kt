...
class MusicWidgetPortrait : AppWidgetProvider() {
    ...
    companion object {
        ...
        fun updateAllWidgets(context: Context) {
            ...
            val widgetIds = appWidgetManager.getAppWidgetIds(
                ComponentName(context, MusicWidgetPortrait::class.java)
            )
        ...
        private fun updateWidget(
            ...
            val views = RemoteViews(context.packageName, R.layout.widget_music_portrait)
            val playerConnection = PlayerConnection.instance
            val player = playerConnection?.player
        ...
        private fun getBroadcastPendingIntent(context: Context, action: String): PendingIntent {
            val intent = Intent(context, MusicWidgetPortrait::class.java).apply {
                this.action = action
            }
