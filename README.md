...
<div align="center">
  <img src="https://github.com/michei69/OpenTune/blob/master/fastlane/metadata/android/en-US/images/featureGraphic.png" alt="OpenTune Banner" width="100%"/>
  
  ### Advanced YouTube Music Client with Material Design 3 for Android
  
  [![Latest Release](https://img.shields.io/github/v/release/michei69/OpenTune?style=flat-square&logo=github&color=0D1117&labelColor=161B22)](https://github.com/michei69/OpenTune/releases)
  [![License](https://img.shields.io/github/license/michei69/OpenTune?style=flat-square&logo=gnu&color=2B3137&labelColor=161B22)](https://github.com/michei69/OpenTune/blob/main/LICENSE)
  ...
  [![Stars](https://img.shields.io/github/stars/michei69/OpenTune?style=flat-square&logo=github&color=yellow&labelColor=161B22)](https://github.com/michei69/OpenTune/stargazers)
...
[![Español](https://img.shields.io/badge/readme.md-spanish-blue?style=for-the-badge)](README.es.md)
...
1. Navigate to the [Releases](https://github.com/michei69/OpenTune/releases) section on GitHub
...
All participants in this project must adhere to our code of conduct that promotes an inclusive, respectful, and constructive environment. Please review the [complete Code of Conduct](https://github.com/michei69/OpenTune/blob/master/CODE_OF_CONDUCT.md) before contributing.
...
1. **Issue Review**: Check [open issues](https://github.com/michei69/OpenTune/issues) or create a new one describing the problem or feature
...
> **Development Guidelines**: Review our [contribution guidelines](https://github.com/michei69/OpenTune/blob/master/CONTRIBUTING.md) for detailed information about development process, code standards, and workflow.
...
This program is distributed in the hope that it will be useful, but **WITHOUT ANY WARRANTY**; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the [GNU General Public License](https://github.com/michei69/OpenTune/blob/main/LICENSE) for more details.
...
<div align="center">
  <p><strong>© 2023-2025 Open Source Projects</strong></p>
  <p>Developed with passion by <a href="https://github.com/Arturo254">Arturo Cervantes</a></p>
  <p>Forked by <a href="https://github.com/michei69">mikey</a></p>
